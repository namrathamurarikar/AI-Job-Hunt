...
Run exactly as per the `oferta` mode (read `modes/oferta.md` for all blocks A-F + Block G Posting Legitimacy).
...
- **Selective without being aloof**: "I've been intentional about finding a team where I can contribute meaningfully from day one"
